...
<html>
  ...
  <body>
    ...
    <div class="grid-container" >
      ...
      <div id="portrait">
        <img src="/material/bilder/portraits/portraitJosef.png" alt="Portrait Josef">
      </div>
  ...
  <div id="section2">
      <div class="map-background" id="josef-map">
        ...
        <button class="map-button de josef-station2-2" onmouseover="popupDescription(this)" onmouseout="hideDescription(this)" onclick="popupVideo('/material/videos/josef03_sd.mp4', '/material/videos/josef03.mp4', this)"></button>
        <div class="map-popup de josef-station2-2">Josef beschreibt  den Transport ins KZ Bergen-Belsen.</div>

        <button class="map-button de josef-station3-1" onmouseover="popupDescription(this)" onmouseout="hideDescription(this)" onclick="popupVideo('/material/videos/josef04_sd.mp4', '/material/videos/josef04.mp4', this)"></button>
        <div class="map-popup de josef-station3-1">Josef erzählt von seinen schrecklichen Erlebnissen im Konzentrationslager.</div>

        <button class="map-button de josef-station3-2" onmouseover="popupDescription(this)" onmouseout="hideDescription(this)" onclick="popupVideo('/material/videos/josef05_sd.mp4', '/material/videos/josef05.mp4', this)"></button>
        <div class="map-popup de josef-station3-2">Josef findet nach seinen traumatischen Erlebnissen langsam zurück ins Leben.</div>

        <button class="map-button de josef-station4-1" onmouseover="popupDescription(this)" onmouseout="hideDescription(this)" onclick="popupVideo('/material/videos/josef06_sd.mp4', '/material/videos/josef06.mp4', this)"></button>
        <div class="map-popup de bella-station4-1">Josef berichtet von den schweren Anfangsjahren in Israel.</div>

        <button class="map-button de josef-station4-2" onmouseover="popupDescription(this)" onmouseout="hideDescription(this)" onclick="popupVideo('/material/videos/josef07_sd.mp4', '/material/videos/josef07.mp4', this)"></button>
        ...
        <button class="map-button en josef-station2-2" onmouseover="popupDescription(this)" onmouseout="hideDescription(this)" onclick="popupVideo('/material/videos/josef03_sd_en.mp4', '/material/videos/josef03_en.mp4', this)"></button>
        <div class="map-popup en josef-station2-2">Josef describes the transport to the concentration camp Bergen-Belsen.</div>

        <button class="map-button en josef-station3-1" onmouseover="popupDescription(this)" onmouseout="hideDescription(this)" onclick="popupVideo('/material/videos/josef04_sd_en.mp4', '/material/videos/josef04_en.mp4', this)"></button>
        ...
        <button class="map-button en josef-station4-2" onmouseover="popupDescription(this)" onmouseout="hideDescription(this)" onclick="popupVideo('/material/videos/josef07_sd_en.mp4', '/material/videos/josef07_en.mp4', this)"></button>
