      ...
      <div class="flex-container2">
        <div class="randlinks"></div>
          <div id="IE-name"> 
            ...
            <span id="name2">&nbsp;Friedmann</span>
         </div> 

         <!--Portrait und Text-->
         <div class="spalte2"></div>
         <div class="spalte3">
           <img src="../material/bilder/portraits/portraitNathan.png" alt="Portrait Nathan" height="100%" width="85.91%">
         </div>
        ...
        <div class="flex-container5">
          ...
          <div class="IE-jahr de">
            <strong>// &nbsp; 1930er</strong> &nbsp; Kindheit in Warschau <br>
            <strong>// &nbsp; 1939</strong> &emsp; Kriegsausbruch in Warschau <br>
            <strong>// &nbsp; 1943-1945</strong> &emsp; Leben im Versteck <br>
			<strong>// &nbsp; 1946</strong> &emsp; Nachkriegszeit in Polen <br>
			<strong>// &nbsp; 1947-1948</strong> &emsp; Einwanderung nach Israel <br>
			<strong>// &nbsp; 1948</strong> &emsp; Die ersten Jahre in Israel <br>
			<strong>// &nbsp; 2015</strong> &emsp; Erinnerungen an die Vergangenheit <br></div>
          <div class="IE-jahr en">
            <strong>// &nbsp; 1930s</strong> &nbsp; Childhood in Warschau <br>
            <strong>// &nbsp; 1939</strong> &emsp; Outbreak of the war in Warsaw <br>
            <strong>// &nbsp; 1943-1945</strong> &emsp; Life in hiding <br>
			<strong>// &nbsp; 1946</strong> &emsp; Post-war period in Poland <br>
			<strong>// &nbsp; 1947-1948</strong> &emsp; Immigration to Israel <br>
			<strong>// &nbsp; 1948</strong> &emsp; The first years in Israel <br>
